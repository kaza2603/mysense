...
import { LayoutDashboard, GraduationCap, LogOut, Menu, BarChart, UserPlus } from 'lucide-vue-next'
      ...
      <Sheet v-model:open="isSidebarOpen">
        ...
        >
          <div id="nav-description" class="sr-only">
            Menu navigasi untuk mengakses bahagian-bahagian panel ibu bapa
          </div>
          ...
          <div class="h-full bg-white flex flex-col">
            <div>
              ...
              >
                <SheetTitle class="sr-only">Panel Ibu Bapa IstimewaKu</SheetTitle>
                <IstimewaKuLogo class="h-8 w-full justify-center" />
                <p class="text-sm font-semibold text-center text-gray-500">Panel Ibu Bapa</p>
              </div>
