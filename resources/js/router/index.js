        ...
        },
        {
            ...
            children: [
                ...
                },
                {
                    ...
                    component: () =>
                        import("@/views/parent/MyChildrenView.vue"),
                    meta: { requiresParentAuth: true },
                },
                {
                    ...
                    component: () =>
                        import("@/views/parent/RegisterStudentView.vue"),
                    meta: { requiresParentAuth: true },
                },
            ],
        },
        {
            ...
            children: [
                ...
                },
                {
                    ...
                    component: () =>
                        import("@/views/admin/SchoolRegistrationView.vue"),
                    meta: { requiresAuth: true },
                },
                {
                    path: "school-classes",
                    ...
                    component: () =>
                        import("@/views/admin/SchoolClassView.vue"),
                    meta: { requiresAuth: true },
                },
            ],
        },
            ...
            children: [
                {
                    ...
                    component: () =>
                        import("@/views/student/DashboardView.vue"),
                ...
                },
                {
                    ...
                    component: () =>
                        import("@/views/student/DigitalBookView.vue"),
                    meta: { requiresStudentAuth: true },
                },
                {
                    path: "student-jadual",
                    name: "student-jadual",
                    component: () =>
                        import("@/views/student/JadualPembelajaranView.vue"),
                    meta: { requiresStudentAuth: true },
                },
                {
                    ...
                    component: () =>
                        import("@/views/student/KuizInteraktifView.vue"),
                    meta: { requiresStudentAuth: true },
                },
                {
                    path: "kuiz-index",
                ...
                },
                {
                    ...
                    component: () =>
                        import("@/views/student/LearningVideosView.vue"),
                    meta: { requiresStudentAuth: true },
                },
            ],
        },
        ...
        },
        {
            ...
            children: [
                ...
                },
                {
                    ...
                    component: () =>
                        import("@/views/teacher/StudentPerformance.vue"),
                },
...
router.beforeEach((to, from, next) => {
    ...
    if (
        to.matched.some(
            (record) => record.path === "/admin" && record.meta.requiresAuth,
        ) &&
    ...
    // Check for parent routes
        ...
        to.matched.some(
            (record) =>
                record.path === "/parent" && record.meta.requiresParentAuth,
        ) &&
    ...
    // Check for student routes
        ...
        to.matched.some(
            (record) =>
                record.path === "/student" && record.meta.requiresStudentAuth,
        ) &&
    ...
    // Check for teacher routes (excluding login page itself)
        ...
        to.matched.some(
            (record) => record.path === "/guru" && record.meta.requiresAuth,
        ) &&
