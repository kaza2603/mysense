                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-600">
                            Pantau keseluruhan sistem pembelajaran
                        </p>
                    </div>
                ...
                <Card class="relative overflow-hidden">
                    ...
                    <CardContent>
                        <div class="space-y-2">
                            ...
                            <div class="text-sm text-gray-600">
                                {{ stats.parentsWithChildren }} dengan anak
                                aktif
                            </div>
                        </div>
                    </CardContent>
                ...
                <Card class="relative overflow-hidden">
                    ...
                    <CardContent>
                        <div class="space-y-2">
                            ...
                            <div class="text-sm text-gray-600">
                                Nisbah 1:{{ stats.teacherStudentRatio }}
                                (guru:pelajar)
                            </div>
                        </div>
                    </CardContent>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between py-2">
                                <span class="text-sm text-gray-600"
                                    >Nisbah Guru:Pelajar</span
                                >
                                <Badge variant="outline"
                                    >1:{{ stats.teacherStudentRatio }}</Badge
                                >
                            </div>
                            <Separator />
                            <div class="flex items-center justify-between py-2">
